...
- **Statistics** (**C**) — a tally sheet counting squares walked, floors descended, monsters and bosses slain, sword swings, shots loosed, skills cast, damage dealt and taken, deaths, gold gathered, items picked up, potions drunk, and quests completed. Two columns: **this run** beside your **lifetime** totals, which survive death and carry across every run. The death screen shows the run's summary.
